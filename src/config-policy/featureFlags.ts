...
const AI_COMMIT_OAUTH_ENV = "FEATURE_AI_COMMIT_OAUTH";
...
export const AI_COMMIT_OAUTH_FLAG = "feature.ai_commit_oauth";
...
export function isAiCommitOAuthEnabled(
  env: NodeJS.ProcessEnv = process.env,
): boolean {
  const value = env[AI_COMMIT_OAUTH_ENV];
  return value === "1" || value === "true";
}
